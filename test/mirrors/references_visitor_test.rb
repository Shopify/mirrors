...
module Mirrors
  class ReferencesVisitorTest < MiniTest::Test
    ...
    def test_constant_nesting
      ...
      expected = [
        Marker.new(type: Marker::TYPE_CONSTANT_REFERENCE, message: :'A::B', file: __FILE__, line: 16),
        Marker.new(type: Marker::TYPE_CONSTANT_REFERENCE, message: :'::A::B', file: __FILE__, line: 17),
      ]
    ...
    def test_victim_class
      ...
      expected = [
        ...
        Marker.new(type: Marker::TYPE_CONSTANT_REFERENCE, message: :Kernel, file: __FILE__, line: 10),
